...
<head>
    ...
    <title>Pronay Laravel Website</title>
        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> 01792993208</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> pronoysaha10042003@gmail.com</a></li>
                    ...
                    <div class="col-md-3">
                        <div class="header-logo">
                            <a href="{{route('user.home')}}" class="logo">
                                <img src="{{asset('img/logo.png')}}" alt="" height=250px width=250px>
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
                ...
                <div class="row" >
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <p>My name is Pronay Shaha.I completed CSE graduation from Southeast University. c,c++,java,html,css,javascript,php,laravel is my favourite language.</p>
                            <ul class="footer-links">
                                <li><a href="#"><i class="fa fa-map-marker"></i>Dhaka,Bangladesh</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>01792993208</a></li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i>pronoyshawon1234@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
